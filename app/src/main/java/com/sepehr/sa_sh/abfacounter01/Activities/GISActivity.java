...
public class GISActivity extends BaseActivity {
    ...
    protected void initialize(){
        ...
        progressBarMapLoading = (ProgressBar) findViewById(R.id.progressBarMapLoading);
    ...
    private void mapOnTouchListener(){
        try {
                    ...
                    if (!mFeatureSelected) {
                        ...
                        mIdentifiedFeature.addDoneLoadingListener(new Runnable() {
                            ...
                            public void run() {
                                ...
                                if(!canUpdateGeometr){
                                    Toast.makeText(getApplicationContext(),"این فیچر قابلیت به روز رسانی ندارد",Toast.LENGTH_SHORT);
                                    return;
                                }
                                else {
            ...
            Toast.makeText(this,"بنظر میرسد این فیچر از به روز رسانی پشتیبانی نمیکند",Toast.LENGTH_SHORT);
        }
